...
for (var ic = 0; ic < inputContainer.length; ic++) {
  console.log('ic: ',ic + '    inputContainer:',inputContainer[ic]);
  var input = inputContainer[ic].getElementsByClassName('vm-md-input');
...
function inputFunction(i) {
  ...
  if(input[0].value.length >= 1) {
    ...
    // console.log(i);
    input[0].className = 'vm-md-input vm-md-input-cor-primaria teste';
  } else {
    console.log('É vazio');
    input[0].className = 'vm-md-input vm-md-input-cor-primaria';
  }
